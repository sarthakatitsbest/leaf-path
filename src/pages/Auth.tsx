        ...
        <Card className="border-border/50 shadow-xl backdrop-blur-sm bg-card/95">
          <CardHeader className="text-center space-y-4 pb-2">
            <motion.div 
              ...
              className="mx-auto w-16 h-16 rounded-2xl gradient-teal-lime flex items-center justify-center shadow-lg"
            >
              <Leaf className="h-8 w-8 text-white" />
            </motion.div>
            <div className="space-y-1">
              <CardTitle className="text-2xl font-poppins">Welcome to EcoTracker</CardTitle>
          ...
          <CardContent className="space-y-6">
            ...
            <Button
              type="button"
              variant="outline"
              className="w-full h-12 gap-3 font-medium border-border/50 hover:bg-muted/50 transition-all"
            ...
            <Tabs defaultValue="signin" className="w-full" onValueChange={clearError}>
              ...
              <TabsContent value="signin" className="mt-6">
                <form onSubmit={handleSignIn} className="space-y-4">
                  ...
                  <Button 
                    type="submit" 
                    className="w-full h-11 gradient-teal-lime text-white font-medium shadow-md hover:opacity-90 transition-opacity" 
                    disabled={isLoading}
                  >
                    {isLoading ? (
                      <>
            ...
            <p className="text-center text-sm text-muted-foreground">
              <Link to="/" className="hover:text-primary transition-colors underline-offset-4 hover:underline">
                ← Back to home
              </Link>
            </p>
          </CardContent>
